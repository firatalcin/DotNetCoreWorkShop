...
namespace ASPNetCoreIntro
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSession();
            //Bellekte tut kim ILogger isterse ona DatabaseLogger ver. Hafýzada tutulacaðý için sadece bir tane oluþturulur.
            services.AddSingleton<ILogger, DatabaseLogger>();
            //Çoklu isteðe cevap verme
            //services.AddScoped<ILogger, DatabaseLogger>();
            //Her seferinde farklý instance oluþturur.
